...
Ubuntu 14.04 LTS和16.04 LTS [[4]](#ubuntu1604)有现成的软件包（18.04应该也可以，<https://launchpad.net/~privacyidea/+archive/ubuntu/privacyidea>）。它们在公共ppa仓库 [[1]](#ppa)中提供，安装时将自动解决所有依赖关系。运行以下命令安装：
