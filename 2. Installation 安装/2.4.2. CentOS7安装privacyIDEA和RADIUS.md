...
>
>最近测试，国内源速度快了，但是，安装requirements.txt时提示python2.7版本太低，中的一些软件需要python3.4以上才能安装，然后安装python3.7把软件安装好后，没有pi-manage命令
>不运行pip install -r requirements.txt直接pip install privacyidea，可以安装完成，也有pi-manage命令，但运行pi-manage时会报错
