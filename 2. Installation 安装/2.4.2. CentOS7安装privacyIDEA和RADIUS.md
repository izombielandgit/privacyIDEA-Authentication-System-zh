...
笔者注：以下是大部分根据[官方教程](https://www.privacyidea.org/two-factor-authentication-with-otp-on-centos-7/)来编写的教程，并参考了部分[superlc320@GitBook](https://www.gitbook.com/book/superlc320/openvpn-freeradius-privacyidea-mariadb-centos7/details)。CentOS7安装完成后调不出setup tool，不过也不算太影响操作，有空再试Ubuntu上的安装。
